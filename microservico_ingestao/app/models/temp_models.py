...
class ProdutoTemp(Base):
    ...
    compras = relationship("CompraTemp", back_populates="produto", cascade="all, delete-orphan")
...
class CompraTemp(Base):
    ...
    produto_id = Column(Integer, ForeignKey("produtos_temp.id", ondelete="CASCADE"), nullable=False)
